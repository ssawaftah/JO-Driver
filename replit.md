...
- `cloudflare-worker/seed.sql` / `seed-questions.sql` are one-time migration dumps (Firebase → D1) kept for historical reference; safe to delete once the migration has been stable for a while.
